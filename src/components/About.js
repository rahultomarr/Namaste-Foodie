...
const About = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch("https://api.github.com/users/rahultomarr");
  ...
  return (
    <div className="bg-gradient-to-r from-red-600 to-red-400 min-h-screen text-white py-16 px-6">
